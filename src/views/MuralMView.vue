...
// Login simulado
const userLogado = ref({ nome: 'Morador Teste', role: 'morador' })

// Avisos (somente leitura)
const avisos = ref([
  ...
  <main>
    <section class="main-content">
      ...
      <section class="avisos">
        <h2>Avisos</h2>
        <p class="p1">Confira os avisos mais recentes.</p>
      ...
      <section class="linha-inferior">
        ...
        <section class="chat">
          ...
          <div class="chat-input">
            <input v-model="novaMensagem" placeholder="Digite uma mensagem..." @keyup.enter="enviarMensagem" />
