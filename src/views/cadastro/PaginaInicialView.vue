...
const irParaLogin = () => {
  router.push('/login') // agora leva pro LoginComponent.vue
}
</script>
...
<template>
  <div class="pagina">
    <div class="conteudo">
      ...
      <div class="acoes">
        <button class="botao" @click="toggleOpcoes">Cadastre-se</button>
        <button class="botao" @click="irParaLogin" >Acessar</button>
      </div>
...
.pagina {
  ...
  min-height: 100vh;
  width: 100lvw;
  background: linear-gradient(to bottom, #6f0a0c, #400507);
  color: white;
